...
<div class="tab-content">
	<div class="tab-pane active" id="general">
		...
		<div class="form-group">
			{!! Form::label('site.ourTeam', 'Our Team:') !!}
		...
		<div class="form-group">
			{!! Form::label('site_mission', 'Our Mission:') !!}
			{!! Form::textarea('site.mission', option('site.mission'), ['class' => 'form-control']) !!}
			{!! $errors->first('site.mission', '<div class="text-danger">:message</div>') !!}
		</div>
		<div class="form-group">

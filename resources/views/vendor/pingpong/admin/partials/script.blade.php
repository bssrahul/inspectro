...
<script src="{!! admin_asset('js/jquery-ui.js') !!}" type="text/javascript"></script>
<script src="{!! admin_asset('js/jquery.maskedinput.js') !!}" type="text/javascript"></script>
<!--script src="{!! admin_asset('js/front.js') !!}" type="text/javascript"></script-->
 <script>
  $(function() {
    $( "#last-logged-in" ).datepicker();
    $("#last-logged-in").mask("99/99/9999");
  });
  </script>
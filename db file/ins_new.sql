...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2016 at 07:59 AM
...
INSERT INTO `quote_requests` (`id`, `user_temp_id`, `service_id`, `full_name`, `email`, `phone_no`, `zipcode`, `selected_options`, `service_request_date`, `status`, `created_at`, `updated_at`) VALUES
(9, 58447, 1, '', 'sukant@mobilyte.com', '', '95131', '[{"qid":"30","op1":[],"op2":77},{"qid":"31","op1":[],"op2":79},{"qid":"33","op1":[],"op2":83}]', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(10, 51594, 1, '', 'ert', '', 'ertert', '[{"qid":"30","op1":[],"op2":77,"op3":78},{"qid":"31","op1":[],"op2":79},{"qid":"33","op1":[],"op2":83}]', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(10, 'polishing', 'polishing', 1, '2016-06-28 09:30:26', '2016-06-28 09:30:26', 0, 0),
(11, 'dfd', 'cvc', 1, '2016-06-28 13:10:54', '2016-06-28 13:10:54', 0, 0),
(12, 'new service', 'new service', 1, '2016-06-28 15:34:26', '2016-06-28 15:34:26', 0, 0),
(13, 'Common Ques', 'For static questions.', 1, '2016-06-30 07:57:48', '2016-06-30 07:57:48', 0, 0);
...
(1, 'Sukant', 'Sharma', 'sukant@mobilyte.com', '$2y$10$jWpODPZe8jKWm07SgkYhwOXHDrO1GvrJrot4fwLIKvJJJQrWGQMb6', 'gh7g8DMmTJaamV6oIDFYG9k6WC28JQWIP75ULLjecVHf2OhpCRamNV7L2ZzT', '2015-12-11 07:07:11', '2016-07-09 08:02:53', '2016-06-14 06:15:43'),
...
--
ALTER TABLE `questions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id of the question', AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `services`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id of the service. this is the key identification for the service', AUTO_INCREMENT=14;
--
